...
\begin{itemize}[leftmargin=*]
    ...
    \item It positions Civilization VI not only as an application domain but also as an experimental long-horizon testbed for future agent-vs.-agent, human-vs.-agent, and cross-LLM strategy comparisons.
\end{itemize}
...
\midrule
Project name & CivStation (package and module name \texttt{civStation}) \\
...
That is the niche CivStation is trying to define. The point is not to claim a fundamentally new algorithmic advance. The point is to treat a turn-based strategy game as a useful systems laboratory for computer use. The environment provides delayed consequences, structured turns, interpretable micro-actions, and an interface rich enough to stress perception, planning, and intervention. CivStation contributes an experimental software architecture that makes those properties measurable rather than anecdotal.
