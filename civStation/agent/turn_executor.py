...
from civStation.utils.debug import DebugOptions, TurnValidator, log_context
from civStation.utils.image_pipeline import ImagePipelineConfig, process_image
...
from civStation.utils.run_log_cache import get_run_log_cache_path
from civStation.utils.screen import capture_screen_pil, execute_action, move_cursor_to_center
from civStation.utils.ui_change_detector import screenshots_similar
...
if TYPE_CHECKING:
    ...
    from civStation.agent.modules.knowledge import KnowledgeManager
    from civStation.agent.modules.strategy import StrategyPlanner
    from civStation.agent.modules.strategy.strategy_updater import StrategyUpdater
...
def route_primitive(
    ...
    """
    from civStation.utils.image_pipeline import ROUTER_DEFAULT
...
def _build_strategy_with_directive(ctx: ContextManager, primitive_name: str) -> str:
    ...
    """
    from civStation.agent.modules.router.primitive_registry import PRIMITIVE_TO_KOREAN
...
def run_one_turn(
    ...
    if strategy_updater and is_new_turn:
        from civStation.agent.modules.strategy.strategy_updater import StrategyRequest, StrategyTrigger
