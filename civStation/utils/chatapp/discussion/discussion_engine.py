...
from civStation.utils.chatapp.discussion.prompts.discussion_prompts import (
...
class StrategyDiscussion:
    ...
    def _parse_strategy_response(self, response: str) -> StructuredStrategy:
        ...
        from civStation.agent.modules.strategy.strategy_schemas import parse_strategy_json
