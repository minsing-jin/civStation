...
from civStation.agent.models.schema import AgentPlan
...
class BaseVLMProvider(ABC):
    ...
    def _prepare_pil_image(self, pil_image, img_config=None):
        ...
        if img_config is not None:
            from civStation.utils.image_pipeline import process_image

            return process_image(pil_image, img_config).image

        if self.resize_for_vlm:
            from civStation.utils.image_pipeline import PLANNER_DEFAULT, process_image
