...
python -m civStation.evaluator.static_eval.civ6_eval.main path/to/test_set.json
```
...
python -m civStation.evaluator.static_eval.civ6_eval.test_tolerance

# Test discriminated union
python -m civStation.evaluator.static_eval.civ6_eval.test_discriminated_union
