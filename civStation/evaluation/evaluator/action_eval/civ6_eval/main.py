...
from civStation.evaluation.evaluator.action_eval.interfaces import GroundTruth
...
Examples:
  ...
  python -m civStation.evaluator.static_eval.civ6_eval.main --provider gemini --test-file my_tests.json
