...
<div align="center">
  <img src="docs/readme_resources/simple_architecture.svg" alt="HITL 주문이 background strategy agent로 들어가고, strategy와 order가 main process action agent로 내려가며, context가 다시 위로 올라가는 간단한 아키텍처 다이어그램" width="100%" />
</div>
