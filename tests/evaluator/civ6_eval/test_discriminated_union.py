"""
Pytest tests for discriminated union functionality.

Tests verify that Pydantic's discriminated union works correctly
for Action types when parsing from dictionaries and JSON.
"""
...
class TestActionParsing:
    """Tests for parsing individual action types from dictionaries."""

    def test_parse_click_action_from_dict(self):
        """Test parsing ClickAction from dictionary."""
    ...
    def test_parse_drag_action_from_dict(self):
        """Test parsing DragAction from dictionary."""
        drag_dict = {
            "type": "drag",
            "start_x": 10,
            "start_y": 20,
        ...
        assert action.duration == 0.5  # Default value
        assert action.button == "left"  # Default value

    def test_parse_drag_action_with_duration(self):
        """Test parsing DragAction with custom duration."""
        drag_dict = {
            "type": "drag",
            "start_x": 10,
            "start_y": 20,
    ...
    def test_parse_wait_action(self):
        """Test parsing WaitAction from dictionary."""
...
class TestAgentPlanParsing:
    """Tests for parsing AgentPlan with multiple action types."""

    def test_parse_plan_with_mixed_actions(self):
        """Test parsing AgentPlan containing multiple action types."""
        plan_dict = {
    ...
    def test_parse_plan_all_action_types(self):
        """Test parsing AgentPlan with all available action types."""
        plan_dict = {
    ...
    def test_parse_plan_empty_actions(self):
        """Test parsing AgentPlan with no actions."""
        plan_dict = {
...
class TestJSONSerialization:
    ...
    def test_json_roundtrip_click_action(self):
        """Test JSON serialization and deserialization of ClickAction."""
    ...
    def test_json_roundtrip_agent_plan(self):
        """Test JSON serialization and deserialization of AgentPlan."""
    ...
    def test_json_with_all_action_types(self):
        """Test JSON round-trip with all action types."""
        plan = AgentPlan(
...
class TestDiscriminatorValidation:
    """Tests for discriminator validation and error handling."""

    def test_discriminator_field_present(self):
        """Test that discriminator field 'type' is present in all actions."""
        actions = [
            ClickAction(type="click", x=100, y=200),
    ...
    def test_action_serialization_includes_type(self):
        """Test that serialized actions include the 'type' discriminator."""
    ...
    def test_discriminator_routes_to_correct_type(self, action_type, expected_class):
        """Test that discriminator correctly routes to appropriate action class."""
        # Create minimal valid dict for each type
        action_dicts = {
