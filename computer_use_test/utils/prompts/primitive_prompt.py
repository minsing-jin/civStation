...
[High-level Strategy]: "{high_level_strategy}"
...
# TODO: 비밀결사 팝업이 잘 안돼면 그냥 Esc하게끔 처리
# ==============================================================================
...
상태 2: 좌측 연구 선택 팝업이 열려 있지 않은데, 연구가 필요한 경우 (우측 하단 '연구 선택' 알림, 플라스크 모양이 있을때)
...
# ==============================================================================
# TODO: Policy selection Prompt --> 일단 작동함.
# TODO: context 업데이트로 policy / action state로 전단계 action을 어떻게 했는지 -> 구조 조정 할예정임
# TODO: 카드 여러개를 보고 text로 판단을 고려하고, 결정하는건 필요
# ==============================================================================
...
현재 게임 화면(Screenshot)을 보고 [High-level Strategy]를 달성하기 위한
...
Case B (정부 선택)인 경우:
- [High-level Strategy]와 각 정부의 보너스 텍스트를 읽고 가장 적합한 정부 카드를 클릭하십시오.
