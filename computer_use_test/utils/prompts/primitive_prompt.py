...
4. 화면 오른쪽 맨 아래에 '다음 턴'이라는 글자와 화살표 아이콘이 보이면:
   - 'enter' 키를 눌러 다음 턴으로 넘겨.

5. 화면 오른쪽 맨 아래에 '연구 선택'이라는 글자와 파란색 플라스크 아이콘이 보이면:
   - 해당 '연구 선택' 버튼을 클릭해.

6. 화면 오른쪽 맨 아래에 '생산 품목'이라는 글자와 주황색 톱니바퀴 아이콘이 보이면:
   - 해당 '생산 품목' 버튼을 클릭해.

7. 화면 오른쪽 맨 아래에 '사회 제도 선택'이라는 글자가 보이면:
   - 해당 버튼을 클릭해.

8. 기타 닫을 수 있는 알림/팝업이 보이면:
   - 'esc' 키를 눌러 닫아.
...
# ==============================================================================
# Governor Management Prompt (New!)
# ==============================================================================
