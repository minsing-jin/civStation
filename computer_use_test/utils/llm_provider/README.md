...
ANTHROPIC_API_KEY=xxx python -m computer_use_test.evaluator.static_eval.civ6_eval.main --provider claude
```
...
1. Create `computer_use_test/utils/provider/your_provider.py`
