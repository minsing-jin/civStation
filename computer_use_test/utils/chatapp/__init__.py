...
Example:
    from computer_use_test.utils.chatapp import create_chat_app, BaseChatApp
...
def create_chat_app(platform: str | ChatAppPlatform, **kwargs) -> BaseChatApp:
    ...
    if platform == ChatAppPlatform.DISCORD:
        from computer_use_test.utils.chatapp.discord_app import DiscordChatApp, DiscordConfig
        ...
        from computer_use_test.utils.chatapp.whatsapp_app import WhatsAppChatApp, WhatsAppConfig
