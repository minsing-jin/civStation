...
from computer_use_test.evaluation.evaluator.action_eval.bbox_eval.schema import CaseResult, DatasetCase
from computer_use_test.evaluation.evaluator.action_eval.bbox_eval.scorer import select_best_gt_set
