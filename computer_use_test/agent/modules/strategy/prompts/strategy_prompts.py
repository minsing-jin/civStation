...
{{
    ...
    "primitive_directives": {{
        "유닛 조작": "전투 유닛: 적극 공격, 적 영토 전진.",
        "도시 생산": "병영 > 군사 유닛 > 성벽 우선.",
        "기술 연구": "청동기 → 철기 군사 기술 경로.",
        "전투": "적극 공격. 적 도시 점령 최우선."
    }}
}}
...
- primitive_directives: 각 프리미티브(유닛, 생산, 연구, 제도, 총독, 외교, 전투, 정책)별
  구체적 행동 기준을 작성. 각 항목 1-2문장으로 간결하게.
"""
...
- 문명6 도메인 지식을 활용해 구체적인 건물, 기술, 유닛 이름을 사용해
- primitive_directives: 각 프리미티브가 전략 실행 시 따라야 할 구체적 행동 기준 (1-2문장씩)
"""
...
- 목표 달성 시 새로운 목표로 교체해
- 상황 악화 시 방어적 조정을 해
- primitive_directives도 상황 변화에 맞게 업데이트해
"""
